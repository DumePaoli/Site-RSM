                  ...
                  {o.license_key && (
                    <div className="space-y-3">
                      ...
                      <div className="flex flex-wrap gap-2">
                        <a href="https://github.com/DumePaoli/RSM-Releases/releases/latest/download/RustServerManagerPro.exe" className="btn-secondary text-xs py-2 px-3" target="_blank" rel="noreferrer">
